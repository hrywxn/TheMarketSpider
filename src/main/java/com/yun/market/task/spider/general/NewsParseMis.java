...
public class NewsParseMis {
    ...
    public void doStartGeneMis(SpiderTaskRulesModel rulesModel, SpiderTaskMode spiderNode) {
        ...
        // 规则
        String rules = String.format("%s", rulesModel.getSpiderRules());
        ...
        //解析
        List<Map<String, String>> kvList = HtmlParCommon.parsingHtmlToContent(html, formatting, rules, kvMap);
